...
var _ = require(process.env.PWD + '/lib/utils');
...
var start = function start(_eventbus, _Team, options) {
	eventbus = _eventbus;
	Team = _Team;

	delay = _.get(options.delay, 20000);	// Add a delay to chat so it doesn't spoil the overlay
