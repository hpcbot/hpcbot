...
describe('House', function() {
	beforeEach(function() {
		...
		var House = require('.');
		house = House.start(eventbus, dbStub);
	});
	...
	describe('Set a user\'s house', function() {
		it('New User (non-muggle): Successfully sorts user into a house', function(done) {
			...
			// Setup stub for hset
			var hsetStub = this.sinon.stub();		// Create a stub for the hset function (db.get().hset)
			...
			var saddStub = this.sinon.stub();		// Create a stub for the sadd function (db.get().sadd)
