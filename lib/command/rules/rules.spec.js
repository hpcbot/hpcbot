...
describe('Rules', function() {
		...
		it('No Parameters: Displays 3 rules', function(done) {
			var user = 'bdickason';
			var command = 'rule';
			var parameters = null;
		...
		it('Accepts rule or rules', function(done) {
			var user = 'bdickason';
			var command = 'rules';
			var parameters = null;
		...
		it('Number parameter 1-3: Displays that rule', function(done) {
			var user = 'bdickason';
			var command = 'rule';
			var parameters = '2';
		...
		it('Number parameter above 3: Displays random rule b/t 4-7', function(done) {
			var user = 'bdickason';
			var parameters = '5';
		...
		it('Number at end of array: Says random rule', function(done) {
			var user = 'bdickason';
			var command = 'rule';
			var parameters = '6';
		...
		it('Non-Number parameter: Doesn\'t display anything', function(done) {
			var user = 'bdickason';
			var command = 'rule';
			var parameters = 'abc';
		...
		it('Doesn\'t show anything if text is entered', function(done) {
			var user = 'bdickason';
			var command = 'rule';
			var parameters = 'abc';
		...
		it('Shows specific rule if number and pound sign is entered', function(done) {
			var user = 'bdickason';
			var command = 'rule';
			var parameters = '#2';
