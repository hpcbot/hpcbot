...
describe('House', function() {
	...
	describe('Chat Triggers', function() {
		it('Contains settings for !house', function() {
			assert.notEqual(House.triggers, null);
			assert.equal(House.triggers[0].name, 'house');
			assert.equal(House.triggers[0].type, 'chat');
			assert.equal(House.triggers[0].whitelist, null);
			assert.equal(House.triggers[0].event, 'house:get');
		});
		it('Contains settings for !sortinghat', function() {
			assert.notEqual(House.triggers, null);
			assert.equal(House.triggers[1].name, 'sortinghat');
			assert.equal(House.triggers[1].type, 'chat');
			assert.equal(House.triggers[1].whitelist, null);
			assert.equal(House.triggers[1].event, 'house:set');
		});
		it('Contains settings for !housetest', function() {
			assert.notEqual(House.triggers, null);
			assert.equal(House.triggers[2].name, 'housetest');
			assert.equal(House.triggers[2].type, 'whisper');
			assert.equal(House.triggers[2].whitelist, true);
			assert.equal(House.triggers[2].event, 'house:test');
		});
	});
